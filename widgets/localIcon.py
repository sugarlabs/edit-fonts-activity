...
activate = """
<svg  transform='translate(10 10)' style="fill:rgb(50,153,50);stroke-width:3.5;stroke:rgb(0,0,0)" enable-background="new 0 0 55.125 55" height="55px" version="1.1" viewBox="0 0 80.125 80" width="55.125px"><g display="block" id="dialog-ok">
...
deactivate = """
<svg height="55px" transform='translate(10 10)' version="1.1" viewBox="0 0 80.125 80" width="55.125px" x="0px" preserveAspectRatio="xMaxYMax meet" style="fill:rgb(229,0,0);stroke-width:3.5;stroke:rgb(0,0,0)"><g display="block" id="dialog-cancel">
...
<svg viewBox="0 0 80 75" width="55px" height="55px" transform='translate(9 9)'>
    <rect x="5" y="5" style="fill:rgb(240,240,240);stroke-width:3.5;stroke:rgb(0,0,0)" width="45" height="45"  stroke-width="3.5"/>
