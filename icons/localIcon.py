...
activate = """
<svg style="fill:rgb(229,0,0);stroke-width:3.5;stroke:rgb(0,0,0)" enable-background="new 0 0 55.125 55" height="55px" version="1.1" viewBox="0 0 55.125 55" width="55.125px" x="0px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" y="0px"><g display="block" id="dialog-ok">
...
<svg width="55px" height="55px" >
    <rect x="5" y="5" style="fill:rgb(229,0,0);stroke-width:3.5;stroke:rgb(0,0,0)" width="45" height="45"  stroke-width="3.5"/>
    <text x="15" y="42" font-size="40" font-family="'Courier New', 'Courier', 'MS Courier New', 'Prestige', monospace" xml:space="preserve">T</text>
</svg>
