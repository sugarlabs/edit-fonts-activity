...
class Font(BaseObject):
    ...
    **This object posts the following notifications:**
    ...
    def __init__(self,
        ...
        self._path = path
        #this gets set when the font is loaded
        self._ufoFormatVersion = None

        #Q:why are they none by default?
        #Q:are they disabled until explicitly set later
        self._kerning = None
        self._info = None
        self._groups = None
        self._features = None
        ...
        #Q:what are layers in a font?
        #A:Different layers contain different sets of Glyphs.
        ...
        #Q: what does 'dirty' represent?
        #A: Dirty means the program has altered the original font data
        self._dirty = False
    ...
    #Not equivalent to saving the file
